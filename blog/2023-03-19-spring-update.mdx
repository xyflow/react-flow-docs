...
title: 'Team update – 11.6.0 is out, Hayleigh is here, and talking about money'
authors: 'john'
...
v.11.6.0 was released too 🎊🎊 with:
...
- We’ve been exploring how we can generalize the core of React Flow, so that it’s not entirely written in React, but also vanilla JS. This could allow React Flow to be adapted more easily to other languages. If "Svelte Flow" sounds interesting to you, [shoot us an email](mailto:info@reactflow.dev), we'd love to talk 👀
