  ...
  react: [
    {
      ...
      description: (
        <>
          ...
          <strong>
            If you want to use mouse handlers for non-draggable nodes, you need to add the class
            name "nopan" to the node.
          </strong>
        </>
      ),
    },
    ...
    },
    {
      ...
      description: (
        <>
          If true, you can focus a node by pressing Tab and select it with Enter. This applies to
          all nodes. You can also change the behavior of a specific node with the{' '}
          <code>focusable</code> node option.
        </>
      ),
    },
    {
      ...
      description: (
        <>
          If true, you can focus an edge by pressing Tab and select it with Enter. This applies to
          all edges. You can also change the behavior of a specific edge with the{' '}
          <code>focusable</code> edge option.
        </>
      ),
    },
    {
