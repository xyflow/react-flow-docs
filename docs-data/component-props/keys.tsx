...
const props = {
  react: [
    ...
    },
    {
      ...
      description: (
        <>
          While pressing the zoomActivationKeyCode you can zoom even if{' '}
          <code>panOnScroll=true</code> or
  ...
  svelte: [
    {
      ...
      type: (
        <>
          string | <Link to="/svelte/api/types">KeyDefinitionObject</Link>
        </>
      ),
      default: "'Backspace'",
      description: (
    ...
    },
    {
      ...
      description: (
        <>
          While pressing the selectionKey and dragging the mouse you can create a selection for
          multiple nodes and edges. You can set it to <code>null</code> to disable functionality
        </>
      ),
    },
